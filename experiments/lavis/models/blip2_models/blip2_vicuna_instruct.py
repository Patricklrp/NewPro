    ...
    def generate(
        ...
        with self.maybe_autocast():
            ...
            outputs = self.llm_model.generate(
                ...
                degf_alpha_pos=degf_alpha_pos if degf_alpha_pos is not None else None,
                degf_alpha_neg=degf_alpha_neg if degf_alpha_neg is not None else None,
                degf_beta=degf_beta if degf_beta is not None else None,
